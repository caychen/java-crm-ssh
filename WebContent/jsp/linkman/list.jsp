											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="lkmName" value="${model.lkmName }"></TD>
													<TD></TD>	
													<TD>所属客户：</TD>
													<TD>
														<select name="customer.custId" id="customerId">
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_initUpdate?lkmId=${linkman.lkmId}">修改</a>
													&nbsp;&nbsp;
